...
object ImageUtils {
    ...
    fun toRound(
        ...
        val ret = Bitmap.createBitmap(width, height, src.config ?: Bitmap.Config.ARGB_8888)
        val center = size / 2f
    ...
    private fun addBorder(
        ...
        if (isEmptyBitmap(src)) return null
        val ret = if (recycle) src else src.copy(src.config ?: Bitmap.Config.ARGB_8888, true)
        val width = ret.width
    ...
    fun addReflection(
        ...
        val ret = Bitmap.createBitmap(
            srcWidth, srcHeight + reflectionHeight,
    ...
    fun addTextWatermark(
        ...
        val ret = src.copy(src.config ?: Bitmap.Config.ARGB_8888, true)
        val paint = Paint(Paint.ANTI_ALIAS_FLAG)
        val canvas = Canvas(ret)
        paint.color = color
